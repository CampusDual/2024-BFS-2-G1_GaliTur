...
public class HotelService implements IHotelService {
    ...
    public EntityResult hotelMultiUpdate(Map<String, Object> attributesValues, Map<String, Object> keysValues) throws OntimizeJEERuntimeException {
        ...
        */
        ...
        if (attributesValues.containsKey("toggleWifi") && (boolean) attributesValues.get("toggleWifi") == true) {
            Map<String, Object> mapSrv = new HashMap<>();

            mapSrv.put(HotelServicesDao.TYPE, "Wifi");
        ...
        if (attributesValues.containsKey("toggleParking") && (boolean) attributesValues.get("toggleParking") == true) {
            Map<String, Object> mapSrv = new HashMap<>();
        ...
        if (attributesValues.containsKey("togglePool") && (boolean) attributesValues.get("togglePool") == true) {
            Map<String, Object> mapSrv = new HashMap<>();
        ...
        if (attributesValues.containsKey("toggleLunch") && (boolean) attributesValues.get("toggleLunch") == true) {
            Map<String, Object> mapSrv = new HashMap<>();
        ...
        if (attributesValues.containsKey("toggleDinner") && (boolean) attributesValues.get("toggleDinner") == true) {
            Map<String, Object> mapSrv = new HashMap<>();
